...
public class CueNumber {
	...
	private static final String URI_MMS = "#Intent;" +
			...
			"component=com.android.mms/.ui.ConversationList"+
			";end";
	private static final String URI_PHONE = "#Intent;"+
			"action=android.intent.action.MAIN;"+
			"category=android.intent.category.LAUNCHER;"+
			"launchFlags=0x10200000;"+
			"component=com.android.contacts/.DialtactsActivity"+
			";end";
    ...
    public void drawCueNumber(Canvas canvas, Paint mPaint, int w, Bitmap mCueBitmap){
    	...
    	if(cueText != null && cueIcon != null){
			...
			canvas.drawText(cueText, (left + (cueIcon.getWidth() - textWidth)/2), 
