...
//    }
	...
	/*public static  Bitmap changeBitmap(Bitmap b) {
		//return b;
		if (true) {// (b.getWidth() == 96 && b.getHeight() == 96) {
			return b;
		}
        ...
        Bitmap mBitmap = Utilities.createCompoundBitmap(mThemeMgr.getRandomAppBgIcon(), theIcon);//b;
...
//		
//        Bitmap mBitmap = Utilities.createCompoundBitmap(mThemeMgr.getRandomAppBgIcon(b), theIcon);//b;
//        
//        return mBitmap;
//	}
	...
	public static Bitmap changeBitmap4Launcher(Bitmap b) {
        ...
        Bitmap mBitmap = Utilities.createCompoundBitmap(mThemeMgr.getRandomAppBgIcon(b), b);//b;
...
//    	}    	
		...
		canvas.drawBitmap(icon, (bgWidth - iconWidth) / 2.0f, (bgHeight - iconHeight) / 2.0f, null);
