...
public final class Configurator {
    ...
    private static final String CONFIG_PACKAGE = "com.vollo.launcher.config";
    ...
    static final String sTopPackage[] ={
    	TOPPACKAGENAME,
    	TOPCLASSNAME,
    	TOPORDER};
	...
	public static Drawable getConfigPackageDrawable(Context context, String drawableName){
    	Drawable drawable = null;
        final String packageName = CONFIG_PACKAGE;
        final Resources res = getConfigResources(context);
    	
    	if(res != null){
    		int resId = res.getIdentifier(drawableName, "drawable", packageName);
	...
	public static String[] getConfigPackageArray(Resources resources, String arrayName){
		String[] array = null;
        final String packageName = CONFIG_PACKAGE;
	...
	public static XmlResourceParser getConfigPackageXml(Context context, String xmlName) {
        final String packageName = CONFIG_PACKAGE;
		final Resources res = getConfigResources(context);
		if(res != null){
	...
	public static BoolValue getConfigPackgeBoolConfig(Context context, String name){
        Context configCtx = getConfigContext(context);
        if (configCtx != null) {
	...
	public static int getIntegerConfig(Context context, String name, int defValue){
	...
	public static boolean getBooleanConfig(Context context, String name, boolean defValue){
	...
	public static int getDimensPixelSize(Context context, String name, int defValue){
