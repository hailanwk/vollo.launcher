...
import com.vollo.launcher.Launcher;
import com.vollo.launcher.R;
import com.vollo.launcher.Utilities;
...
//	private static final String KEY_LOCK_SCREEN = "settings_key_lockscreen";
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
		...
		if (key.equals(KEY_THEME)) {
			intent = new Intent();
			intent.setAction("com.huaqin.action.THEME");
			try{
    ...
    private boolean removePreferenceByConfig(PreferenceGroup preferenceGroup, 
    	...
    	boolean bUnInstall = !Utilities.isPackageInstall(this, "com.huaqin.thememgr");
